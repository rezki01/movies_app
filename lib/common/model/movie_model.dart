...
class MovieModel {
  ...
  static List<MovieModel> dummies = [
    ...
    MovieModel(
      ...
      about:
          "Briggs, a US Army soldier, is assigned to take Lulu, a Belgian Malinois military dog, along the Pacific Coast in hopes of arriving at a fellow soldier's funeral on time.",
    ),
    MovieModel(
    ...
    MovieModel(
      ...
      about:
          "The Lost City[5] is a 2022 American action-adventure comedy film directed by the Nee brothers, who co-wrote the screenplay with Oren Uziel and Dana Fox, based on a story by Seth Gordon.[6] Starring Sandra Bullock, Channing Tatum, Daniel Radcliffe, Da'Vine Joy Randolph and Brad Pitt, the film follows a romance novelist and her cover model, who must escape a billionaire who wants her to find a lost ancient burial chamber described in one of her books.",
    ),
    MovieModel(
